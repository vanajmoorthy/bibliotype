...
```bash
pnpm run build          # Compiles assets/css/input.css → static/dist/output.css (minified)
...
- **Frontend:** Tailwind CSS 4 (custom @theme in `assets/css/input.css`), Alpine.js 3, Chart.js (both CDN)
