...
from core.services.user_similarity_service import calculate_user_similarity, find_similar_users
...
class RecommendationTestCase(TestCase):
    ...
    def test_find_similar_users(self):
        ...
        ub = UserBook.objects.create(
            user=self.user1, book=self.book4, user_rating=5, is_top_book=True, top_book_position=1
        )
    ...
    def test_top_books_sentiment_analysis(self):
        ...
        UserBook.objects.create(user=self.user1, book=self.book2, user_rating=4, user_review="It was okay.")
...
class PrivacyTestCase(TestCase):
    ...
    def test_public_users_appear_in_recommendations(self):
        ...
        shared_book = Book.objects.create(title="Shared Book", author=author1, publisher=publisher1, average_rating=4.5)
