...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("--overwrite", action="store_true", help="Overwrite existing DNA data")
    ...
    def generate_dna_from_userbooks(self, user_books, user):
        ...
        for user_book in user_books:
            ...
            if user_book.user_review:
                ...
                review_data = {"book_title": book.title, "review": user_book.user_review, "sentiment": sentiment}
            ...
            if (book.author and book.author.is_mainstream) or (book.publisher and book.publisher.is_mainstream):
                mainstream_count += 1
    ...
    def generate_synthetic_dna(self):
        ...
        dna = {
            ...
            "most_niche_book": (
                controversial_books[0] if controversial_books else {"title": "Unknown", "average_rating": 3.5}
            ),
            "reader_type": reader_type,
