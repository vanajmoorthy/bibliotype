    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                "ordering": ["-created_at"],
                "indexes": [
                    models.Index(fields=["reader_type", "created_at"], name="core_anonym_reader__a99942_idx"),
                    models.Index(fields=["total_books_read"], name="core_anonym_total_b_d11baf_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(fields=["session_key", "expires_at"], name="core_anonym_session_b6e673_idx"),
                    models.Index(fields=["expires_at", "anonymized"], name="core_anonym_expires_0b0804_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "book",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="readers", to="core.book"
                    ),
                ),
                (
                    "user",
            ...
            options={
                "indexes": [
                    models.Index(fields=["user", "is_top_book"], name="core_userbo_user_id_0337ca_idx"),
                    models.Index(fields=["book", "is_top_book"], name="core_userbo_book_id_813e1b_idx"),
                ],
